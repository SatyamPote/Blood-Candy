...
fn discover_definition_roots(cwd: &Path, leaf: &str) -> Vec<(DefinitionSource, PathBuf)> {
    ...
    for ancestor in cwd.ancestors() {
        push_unique_root(
            ...
            ancestor.join(".bloodcandy").join(leaf),
        );
        push_unique_root(
            &mut roots,
    ...
    if let Some(home) = env::var_os("HOME") {
        ...
        push_unique_root(
            ...
            home.join(".bloodcandy").join(leaf),
        );
        push_unique_root(
            &mut roots,
...
fn discover_skill_roots(cwd: &Path) -> Vec<SkillRoot> {
    ...
    for ancestor in cwd.ancestors() {
        push_unique_skill_root(
            &mut roots,
            DefinitionSource::ProjectClaw,
            ancestor.join(".bloodcandy").join("skills"),
            SkillOrigin::SkillsDir,
        );
        push_unique_skill_root(
            &mut roots,
        ...
        push_unique_skill_root(
            &mut roots,
            DefinitionSource::ProjectClaw,
            ancestor.join(".bloodcandy").join("commands"),
            SkillOrigin::LegacyCommandsDir,
        );
        push_unique_skill_root(
            &mut roots,
    ...
    if let Some(home) = env::var_os("HOME") {
        ...
        push_unique_skill_root(
            &mut roots,
            DefinitionSource::UserClaw,
            home.join(".bloodcandy").join("skills"),
            SkillOrigin::SkillsDir,
        );
        push_unique_skill_root(
            &mut roots,
        ...
        push_unique_skill_root(
            &mut roots,
            DefinitionSource::UserClaw,
            home.join(".bloodcandy").join("commands"),
            SkillOrigin::LegacyCommandsDir,
        );
        push_unique_skill_root(
            &mut roots,
...
fn default_skill_install_root() -> std::io::Result<PathBuf> {
    ...
    if let Some(home) = env::var_os("HOME") {
        return Ok(PathBuf::from(home).join(".bloodcandy").join("skills"));
    }
    Err(std::io::Error::new(
        std::io::ErrorKind::NotFound,
...
fn render_agents_usage(unexpected: Option<&str>) -> String {
    let mut lines = vec![
        ...
        "  Direct CLI       bloodcandy agents".to_string(),
        "  Sources          .bloodcandy/agents, ~/.bloodcandy/agents, $CLAW_CONFIG_HOME/agents".to_string(),
    ];
...
fn render_agents_usage_json(unexpected: Option<&str>) -> Value {
    json!({
        ...
        "usage": {
            ...
            "direct_cli": "bloodcandy agents [list|help]",
            "sources": [".bloodcandy/agents", "~/.bloodcandy/agents", "$CLAW_CONFIG_HOME/agents"],
        },
...
fn render_skills_usage(unexpected: Option<&str>) -> String {
    let mut lines = vec![
        ...
        "  Direct CLI       bloodcandy skills [list|install <path>|help|<skill> [args]]".to_string(),
        "  Invoke           /skills help overview -> $help overview".to_string(),
        "  Install root     $CLAW_CONFIG_HOME/skills or ~/.bloodcandy/skills".to_string(),
        "  Sources          .bloodcandy/skills, .omc/skills, .agents/skills, .codex/skills, .claude/skills, ~/.bloodcandy/skills, ~/.omc/skills, ~/.claude/skills/omc-learned, ~/.codex/skills, ~/.claude/skills, legacy /commands".to_string(),
    ];
    if let Some(args) = unexpected {
        lines.push(format!("  Unexpected       {args}"));
    }
...
fn render_skills_usage_json(unexpected: Option<&str>) -> Value {
    json!({
        ...
        "usage": {
            ...
            "aliases": ["/skill"],
            "direct_cli": "bloodcandy skills [list|install <path>|help|<skill> [args]]",
            "invoke": "/skills help overview -> $help overview",
            "install_root": "$CLAW_CONFIG_HOME/skills or ~/.bloodcandy/skills",
            "sources": [
                ".bloodcandy/skills",
                ".omc/skills",
                ".agents/skills",
...
fn render_mcp_usage(unexpected: Option<&str>) -> String {
    let mut lines = vec![
        ...
        "  Direct CLI       bloodcandy mcp [list|show <server>|help]".to_string(),
        "  Sources          .bloodcandy/settings.json, .bloodcandy/settings.local.json".to_string(),
    ];
    if let Some(args) = unexpected {
        lines.push(format!("  Unexpected       {args}"));
    }
...
fn render_mcp_usage_json(unexpected: Option<&str>) -> Value {
    json!({
        ...
        "usage": {
            ...
            "direct_cli": "bloodcandy mcp [list|show <server>|help]",
            "sources": [".bloodcandy/settings.json", ".bloodcandy/settings.local.json"],
        },
        "unexpected": unexpected,
    })
}
...
mod tests {
    ...
    fn renders_agents_reports_as_json() {
        ...
        assert_eq!(help["usage"]["direct_cli"], "bloodcandy agents [list|help]");
    ...
    fn resolves_project_skills_and_legacy_commands_from_shared_registry() {
        ...
        let project_skills = workspace.join(".bloodcandy").join("skills");
        let legacy_commands = workspace.join(".bloodcandy").join("commands");
    ...
    fn renders_skills_reports_as_json() {
        ...
        assert_eq!(
            ...
            "bloodcandy skills [list|install <path>|help|<skill> [args]]"
        );
    ...
    fn agents_and_skills_usage_support_help_and_unexpected_args() {
        ...
        assert!(agents_help.contains("Direct CLI       bloodcandy agents"));
        assert!(agents_help
            .contains("Sources          .bloodcandy/agents, ~/.bloodcandy/agents, $CLAW_CONFIG_HOME/agents"));
        ...
        assert!(skills_help.contains("Install root     $CLAW_CONFIG_HOME/skills or ~/.bloodcandy/skills"));
    ...
    fn mcp_usage_supports_help_and_unexpected_args() {
        ...
        assert!(help.contains("Direct CLI       bloodcandy mcp [list|show <server>|help]"));
    ...
    fn renders_mcp_reports_from_loaded_config() {
        ...
        fs::create_dir_all(workspace.join(".bloodcandy")).expect("workspace config dir");
        fs::create_dir_all(&config_home).expect("config home");
        fs::write(
            workspace.join(".bloodcandy").join("settings.json"),
            r#"{
              "mcpServers": {
                "alpha": {
                  "command": "uvx",
        ...
        fs::write(
            workspace.join(".bloodcandy").join("settings.local.json"),
            r#"{
              "mcpServers": {
                "remote": {
                  "type": "ws",
    ...
    fn renders_mcp_reports_as_json() {
        ...
        assert_eq!(help["action"], "help");
        assert_eq!(help["usage"]["sources"][0], ".bloodcandy/settings.json");
